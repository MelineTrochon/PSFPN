...
// void make_matrix(int n, int* IRN, int* JCN, double* A) {
//     int NNZ = 3 * n - 2;
...
// void show_matrix(int n, int * IRN, int* JCN, double* A) {
//     int NNZ = 3 * n - 2;
//     for (int i = 0; i < NNZ; i++) {
//         printf("i = %d, j = %d, A = %f", IRN[i], JCN[i], A[i]);
//     }
// }
...
//     int* JCN;
//     double* A;
//     make_matrix(10, IRN, JCN, A);
//     show_matrix(10, IRN, JCN, A);
//     return 0;
// }
